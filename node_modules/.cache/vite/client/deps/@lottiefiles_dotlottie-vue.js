...
var F = (c, n) => {
  for (var i in n || (n = {})) a3.call(n, i) && p2(c, i, n[i]);
  if (W1) for (var i of W1(n)) o3.call(n, i) && p2(c, i, n[i]);
  return c;
};
var k = (c, n) => o0(c, s0(n));
var $1 = (c, n) => {
  var i = {};
  for (var d in c) a3.call(c, d) && n.indexOf(d) < 0 && (i[d] = c[d]);
  if (c != null && W1) for (var d of W1(c)) n.indexOf(d) < 0 && o3.call(c, d) && (i[d] = c[d]);
  return i;
};
...
var d0 = (() => {
  ...
  return function(i = {}) {
    ...
    function x2(e) {
      if (e == h1 && P1) return new Uint8Array(P1);
    ...
    var G1 = (e) => {
      ...
      var a = t + r;
      for (r = t; e[r] && !(r >= a); ) ++r;
      if (16 < r - t && e.buffer && k2) return k2.decode(e.subarray(t, r));
      for (a = ""; t < r; ) {
        var o = e[t++];
        if (o & 128) {
          var u = e[t++] & 63;
          if ((o & 224) == 192) a += String.fromCharCode((o & 31) << 6 | u);
            ...
            var h4 = e[t++] & 63;
            o = (o & 240) == 224 ? (o & 15) << 12 | u << 6 | h4 : (o & 7) << 18 | u << 12 | h4 << 6 | e[t++] & 63, 65536 > o ? a += String.fromCharCode(o) : (o -= 65536, a += String.fromCharCode(55296 | o >> 10, 56320 | o & 1023));
          }
    ...
    var O2 = 0, p1 = (e, t, r) => {
      ...
      if (0 < r) {
        ...
        for (var o = 0; o < e.length; ++o) {
          ...
          if (55296 <= u && 57343 >= u) {
            var h4 = e.charCodeAt(++o);
            u = 65536 + ((u & 1023) << 10) | h4 & 1023;
          }
          if (127 >= u) {
            if (t >= r) break;
            a[t++] = u;
    ...
    var o1 = {}, e1 = {}, F1 = {}, f1, X = (e, t, r) => {
      ...
      e.forEach((l) => F1[l] = t);
      var o = Array(t.length), u = [], h4 = 0;
      t.forEach((l, p) => {
        e1.hasOwnProperty(l) ? o[p] = e1[l] : (u.push(l), o1.hasOwnProperty(l) || (o1[l] = []), o1[l].push(() => {
          o[p] = e1[l], ++h4, h4 === u.length && a(o);
        }));
      }), u.length === 0 && a(o);
    }, B2, R = (e) => {
      for (var t = ""; T[e]; ) t += B2[T[e++]];
      return t;
    }, y;
    function C3(e, t, r = {}) {
      var a = t.name;
    ...
    var K1 = (e) => {
      ...
      for (; e.Ga; ) t = e.Pa(t), e = e.Ga;
      return g1[t];
    }, x1 = (e, t) => {
      if (!t.Da || !t.Ca) throw new f1("makeClassHandle requires ptr and ptrType");
      if (!!t.Ha != !!t.Ea) throw new f1("Both smartPtrType and smartPtr must be specified");
    ...
    var w1 = (e, t) => Object.defineProperty(t, "name", { value: e }), U2 = (e, t, r) => {
      if (e[t].Fa === void 0) {
        var a = e[t];
        e[t] = function(...o) {
          if (!e[t].Fa.hasOwnProperty(o.length)) throw new y(`Function '${r}' called with an invalid number of arguments (${o.length}) - expects one of (${e[t].Fa})!`);
          return e[t].Fa[o.length].apply(this, o);
        }, e[t].Fa = [], e[t].Fa[a.Qa] = a;
      }
    }, Z1 = (e, t, r) => {
      if (s.hasOwnProperty(e)) {
        if (r === void 0 || s[e].Fa !== void 0 && s[e].Fa[r] !== void 0) throw new y(`Cannot register public name '${e}' twice`);
        if (U2(s, e, e), s.hasOwnProperty(r)) throw new y(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
        s[e].Fa[r] = t;
      } else s[e] = t, r !== void 0 && (s[e].qb = r);
    }, M3 = (e) => {
    ...
    function E3(e, t, r, a, o, u, h4, l) {
      this.name = e, this.constructor = t, this.Na = r, this.Ka = a, this.Ga = o, this.bb = u, this.Pa = h4, this.$a = l, this.jb = [];
    }
    var Q1 = (e, t, r) => {
      for (; t !== r; ) {
        if (!t.Pa) throw new y(`Expected null or instance of ${r.name}, got an instance of ${t.name}`);
        e = t.Pa(e), t = t.Ga;
      }
      return e;
    };
    function P3(e, t) {
      ...
      if (!t.Aa) throw new y(`Cannot pass "${o2(t)}" as a ${this.name}`);
    ...
    function I3(e, t) {
      ...
      if (!t || !t.Aa) throw new y(`Cannot pass "${o2(t)}" as a ${this.name}`);
      if (!t.Aa.Ca) throw new y(`Cannot pass deleted object as a pointer of type ${this.name}`);
      ...
      if (r = Q1(t.Aa.Ca, t.Aa.Da.Ba, this.Ba), this.Sa) {
        if (t.Aa.Ea === void 0) throw new y("Passing raw pointer to smart pointer is illegal");
        switch (this.ob) {
          case 0:
            if (t.Aa.Ha === this) r = t.Aa.Ea;
            else throw new y(`Cannot convert argument of type ${t.Aa.Ha ? t.Aa.Ha.name : t.Aa.Da.name} to parameter type ${this.name}`);
            break;
          case 1:
            r = t.Aa.Ea;
            break;
    ...
    function b1(e, t, r, a, o, u, h4, l, p, v, f) {
      this.name = e, this.Ba = t, this.Ta = r, this.Ra = a, this.Sa = o, this.ib = u, this.ob = h4, this.Ya = l, this.Ua = p, this.kb = v, this.Ka = f, o || t.Ga !== void 0 ? this.toWireType = I3 : (this.toWireType = a ? P3 : S3, this.Ja = null);
    }
    var j2 = (e, t, r) => {
      if (!s.hasOwnProperty(e)) throw new f1("Replacing nonexistent public symbol");
    ...
    function F3(e) {
      for (var t = 1; t < e.length; ++t) if (e[t] !== null && e[t].Ja === void 0) return true;
      return false;
    }
    function t2(e, t, r, a, o) {
      var u = t.length;
      if (2 > u) throw new y("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var h4 = t[1] !== null && r !== null, l = F3(t), p = t[0].name !== "void", v = u - 2, f = Array(v), w = [], C = [];
      return w1(e, function(...$) {
        if (C.length = 0, w.length = h4 ? 2 : 1, w[0] = o, h4) {
          var S = t[1].toWireType(C, this);
          w[1] = S;
        }
        for (var A = 0; A < v; ++A) f[A] = t[A + 2].toWireType(C, $[A]), w.push(f[A]);
        if ($ = a(...w), l) q1(C);
        else for (A = h4 ? 1 : 2; A < t.length; A++) {
          var J = A === 1 ? S : f[A - 2];
    ...
    var V2 = (e) => {
      ...
      var r = e1[e];
      if (r === void 0) throw e = `${t} has unknown type ${N2(e)}`, new y(e);
      return r;
    }, o2 = (e) => {
      ...
      if (r <<= 1, 32 < r - e && J2) return J2.decode(T.subarray(e, r));
      for (r = "", a = 0; !(a >= t / 2); ++a) {
        var o = a1[e + 2 * a >> 1];
        if (o == 0) break;
      ...
      for (var r = Array(e), a = 0; a < e; ++a) r[a] = a2(E[t + 4 * a >> 2], "parameter " + a);
      return r;
    }, N3 = Reflect.construct, C1 = {}, q22 = (e) => {
      if (!(e instanceof R2 || e == "unwind")) throw e;
    }, d2 = 0, K2 = (e) => {
      var t;
      ...
      if (!l2) {
        ...
        for (t in u2) u2[t] === void 0 ? delete e[t] : e[t] = u2[t];
        var r = [];
    ...
    for (var Z2 = Array(256), O1 = 0; 256 > O1; ++O1) Z2[O1] = String.fromCharCode(O1);
    B2 = Z2, y = s.BindingError = class extends Error {
      constructor(e) {
        super(e), this.name = "BindingError";
      }
    }, Object.assign(D1.prototype, { isAliasOf: function(e) {
      if (!(this instanceof D1 && e instanceof D1)) return false;
      var t = this.Aa.Da.Ba, r = this.Aa.Ca;
      e.Aa = e.Aa;
      var a = e.Aa.Da.Ba;
      for (e = e.Aa.Ca; t.Ga; ) r = t.Pa(r), t = t.Ga;
      for (; a.Ga; ) e = a.Pa(e), a = a.Ga;
      return t === a && r === e;
    }, clone: function() {
      if (this.Aa.Ca || K1(this), this.Aa.Oa) return this.Aa.count.value += 1, this;
      ...
      if (this.Aa.Ca || K1(this), this.Aa.Ma && !this.Aa.Oa) throw new y("Object already scheduled for deletion");
      W2(this);
      var e = this.Aa;
      ...
      var e = [], t;
      for (t in g1) g1.hasOwnProperty(t) && e.push(g1[t]);
      return e;
      ...
      var a = L3(this.Ba, r);
      if (a !== void 0) return a.Aa.count.value === 0 ? (a.Aa.Ca = r, a.Aa.Ea = e, a.clone()) : (a = a.clone(), this.Wa(e), a);
      if (a = this.Ba.bb(r), a = z2[a], !a) return t.call(this);
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var q3 = { c: (e, t, r, a) => {
      ...
      var t = T1[e];
      delete T1[e];
      var r = t.Ua, a = t.Ka, o = t.Xa, u = o.map((h4) => h4.gb).concat(o.map((h4) => h4.mb));
      X([e], u, (h4) => {
        var l = {};
        return o.forEach((p, v) => {
          var f = h4[v], w = p.eb, C = p.fb, $ = h4[v + o.length], S = p.lb, A = p.nb;
    ...
    }, r: (e, t, r, a, o, u, h4, l, p, v, f, w, C) => {
      f = R(f), u = O(o, u), l && (l = O(h4, l)), v && (v = O(p, v)), C = O(w, C);
      var $ = M3(f);
      Z1($, function() {
        R1(`Cannot construct ${f} due to unbound types`, [a]);
      }), X([e, t, r], a ? [a] : [], (S) => {
        if (S = S[0], a) var A = S.Ba, J = A.Na;
        else J = D1.prototype;
        S = w1(f, function(...c2) {
          if (Object.getPrototypeOf(this) !== L1) throw new y("Use 'new' to construct " + f);
          if (z.La === void 0) throw new y(f + " has no accessible constructor");
          var r3 = z.La[c2.length];
          if (r3 === void 0) throw new y(`Tried to invoke ctor of ${f} with invalid number of parameters (${c2.length}) - expected (${Object.keys(z.La).toString()}) parameters instead!`);
      ...
      o = O(a, o), X([], [e], (l) => {
        ...
        return l.Ba.La[t - 1] = () => {
          R1(`Cannot construct ${l.name} due to unbound types`, h4);
        }, X([], h4, (v) => (v.splice(1, 0, null), l.Ba.La[t - 1] = t2(p, v, null, o, u), [])), [];
      });
    }, f: (e, t, r, a, o, u, h4, l) => {
      var p = e2(r, a);
      t = R(t), t = V2(t), u = O(o, u), X([], [e], (v) => {
        ...
        var C = v.Ba.Na, $ = C[t];
        return $ === void 0 || $.Fa === void 0 && $.className !== v.name && $.Qa === r - 2 ? (f.Qa = r - 2, f.className = v.name, C[t] = f) : (U2(C, t, w), C[t].Fa[r - 2] = f), X([], p, (S) => (S = t2(w, S, v, u, h4), C[t].Fa === void 0 ? (S.Qa = r - 2, C[t] = S) : C[t].Fa[r - 2] = S, [])), [];
      });
      ...
      }, toWireType: (u, h4) => h4.value, Ia: 8, readValueFromPointer: x3(t, r, a), Ja: null }), Z1(t, o);
    }, k: (e, t, r) => {
      var a = a2(e, "enum");
      ...
      e = R(e), e = V2(e), o = O(a, o), Z1(e, function() {
        R1(`Cannot call ${e} due to unbound types`, h4);
      }, t - 1), X([], h4, (l) => (j2(e, t2(e, [l[0], null].concat(l.slice(1)), null, o, u), t - 1), []));
    }, l: (e, t, r, a, o) => {
      if (t = R(t), o === -1 && (o = 4294967295), o = (l) => l, a === 0) {
        var u = 32 - 8 * r;
        o = (l) => l << u >>> u;
      }
      var h4 = t.includes("unsigned") ? function(l, p) {
        return p >>> 0;
      } : function(l, p) {
        return p;
      };
      H(e, { name: t, fromWireType: o, toWireType: h4, Ia: 8, readValueFromPointer: R3(t, r, a !== 0), Ja: null });
    }, h: (e, t, r) => {
      function a(u) {
      ...
      H(e, k3);
    }, ea: (e, t, r, a, o, u, h4, l, p, v, f, w) => {
      r = R(r), u = O(o, u), l = O(h4, l), v = O(p, v), w = O(f, w), X([e], [t], (C) => (C = C[0], [new b1(r, C.Ba, false, false, true, C, a, u, l, v, w)]));
    }, E: (e, t) => {
      t = R(t);
      var r = t === "std::string";
      H(e, { name: t, fromWireType: function(a) {
        var o = E[a >> 2], u = a + 4;
        if (r) for (var h4 = u, l = 0; l <= o; ++l) {
          var p = u + l;
          if (l == o || T[p] == 0) {
            if (h4 = h4 ? c1(T, h4, p - h4) : "", v === void 0) var v = h4;
            else v += "\0", v += h4;
            h4 = p + 1;
          }
        }
        else {
          for (v = Array(o), l = 0; l < o; ++l) v[l] = String.fromCharCode(T[u + l]);
          v = v.join("");
        }
        return Y(a), v;
      }, toWireType: function(a, o) {
        o instanceof ArrayBuffer && (o = new Uint8Array(o));
        var u, h4 = typeof o == "string";
        if (!(h4 || o instanceof Uint8Array || o instanceof Uint8ClampedArray || o instanceof Int8Array)) throw new y("Cannot pass non-string to std::string");
        if (r && h4) for (var l = u = 0; l < o.length; ++l) {
          var p = o.charCodeAt(l);
          127 >= p ? u++ : 2047 >= p ? u += 2 : 55296 <= p && 57343 >= p ? (u += 4, ++l) : u += 3;
        }
        else u = o.length;
        if (l = h2(4 + u + 1), p = l + 4, E[l >> 2] = u, r && h4) p1(o, p, u + 1);
        else if (h4) for (h4 = 0; h4 < u; ++h4) {
          var v = o.charCodeAt(h4);
          if (255 < v) throw Y(p), new y("String has UTF-16 code units that do not fit in 8 bits");
          T[p + h4] = v;
        }
        else for (h4 = 0; h4 < u; ++h4) T[p + h4] = o[h4];
        return a !== null && a.push(Y, l), l;
      }, Ia: 8, readValueFromPointer: v1, Ja(a) {
        Y(a);
      } });
    }, t: (e, t, r) => {
      if (r = R(r), t === 2) var a = O3, o = B3, u = W3, h4 = (l) => u1[l >> 1];
      else t === 4 && (a = $3, o = z3, u = U3, h4 = (l) => E[l >> 2]);
      H(e, { name: r, fromWireType: (l) => {
        for (var p = E[l >> 2], v, f = l + 4, w = 0; w <= p; ++w) {
          var C = l + 4 + w * t;
          (w == p || h4(C) == 0) && (f = a(f, C - f), v === void 0 ? v = f : (v += "\0", v += f), f = C + t);
        }
        return Y(l), v;
      }, toWireType: (l, p) => {
    ...
    }, j: (e, t, r, a, o, u, h4, l, p, v) => {
      T1[e].Xa.push({ ab: R(t), gb: r, eb: O(a, o), fb: u, mb: h4, lb: O(l, p), nb: v });
    }, $: (e, t) => {
      ...
      e--;
      var u = Array(e);
      return t = `methodCaller<(${a.map((h4) => h4.name).join(", ")}) => ${o.name}>`, j3(w1(t, (h4, l, p, v) => {
        for (var f = 0, w = 0; w < e; ++w) u[w] = a[w].readValueFromPointer(v + f), f += a[w].Ia;
        return l = r === 1 ? N3(l, u) : l.apply(h4, u), h4 = [], l = o.toWireType(h4, l), h4.length && (E[p >> 2] = k1(h4)), l;
      }));
    }, da: (e) => {
      9 < e && (K[e + 1] += 1);
    }, aa: (e) => {
      ...
      o = new Date(o, 6, 1).getTimezoneOffset(), E[e >> 2] = 60 * Math.max(u, o), Z[t >> 2] = +(u != o), t = (h4) => {
        var l = Math.abs(h4);
        return `UTC${0 <= h4 ? "-" : "+"}${String(Math.floor(l / 60)).padStart(2, "0")}${String(l % 60).padStart(2, "0")}`;
      ...
      for (var o = 0, u = 0; u < r; u++) {
        var h4 = E[t >> 2], l = E[t + 4 >> 2];
        t += 8;
        for (var p = 0; p < l; p++) {
          var v = e, f = T[h4 + p], w = G3[v];
      ...
      var t = { a: q3 };
      if (Q++, (r = s.monitorRunDependencies) == null || r.call(s, Q), s.instantiateWasm) try {
    ...
    var t3 = s.dynCall_vijjj = (e, t, r, a, o, u, h4, l) => (t3 = s.dynCall_vijjj = P.ua)(e, t, r, a, o, u, h4, l);
    s.dynCall_jiji = (e, t, r, a, o) => (s.dynCall_jiji = P.va)(e, t, r, a, o), s.dynCall_viijii = (e, t, r, a, o, u, h4) => (s.dynCall_viijii = P.wa)(e, t, r, a, o, u, h4), s.dynCall_iiiiij = (e, t, r, a, o, u, h4) => (s.dynCall_iiiiij = P.xa)(e, t, r, a, o, u, h4), s.dynCall_iiiiijj = (e, t, r, a, o, u, h4, l, p) => (s.dynCall_iiiiijj = P.ya)(e, t, r, a, o, u, h4, l, p), s.dynCall_iiiiiijj = (e, t, r, a, o, u, h4, l, p, v) => (s.dynCall_iiiiiijj = P.za)(e, t, r, a, o, u, h4, l, p, v);
    function K3(e, t) {
      var r = G();
      try {
        j.get(e)(t);
    ...
    function r0(e, t, r, a, o, u, h4, l) {
      var p = G();
      try {
        t3(e, t, r, a, o, u, h4, l);
      } catch (v) {
        if (V(p), v !== v + 0) throw v;
        N(1, 0);
      }
    }
    var B1;
    ...
    function n3() {
      function e() {
        ...
        if (!B1 && (B1 = true, s.calledRun = true, !S1)) {
          if (G1(A2), m(s), (r = s.onRuntimeInitialized) == null || r.call(s), s.postRun) for (typeof s.postRun == "function" && (s.postRun = [s.postRun]); s.postRun.length; ) {
      ...
      if (!(0 < Q)) {
        if (s.preRun) for (typeof s.preRun == "function" && (s.preRun = [s.preRun]); s.preRun.length; ) _3();
...
function g2(c) {
  ...
  for (let i = 0; i < U1.length; i += 1) if (U1[i] !== n[i]) return false;
  return true;
}
function l3(c) {
