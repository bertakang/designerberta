<template>
    <div ref="logoContainer">
        <!-- <div class="navbar">
    <button @click="animateLogoAndGrid">My Work</button>
  </div> -->
...
const animateLogoAndGrid = () => {
    anime.timeline()
        .add({
            targets: '.logo path, .logo line, .logo polyline',
    ...
    .add({
      ...
      complete: animateGrid // Trigger grid animation once logo is done
    });
};
